...
class CinemaRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): CinemaRepository =
                instance ?: synchronized(this) {
                    instance ?: CinemaRepository(remoteData, localData, appExecutors)
                }
    }
